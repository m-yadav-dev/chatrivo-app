...
function AvatarBadge({
  ...
  return (
    <span
      ...
      className={cn(
        "absolute right-0.5 bottom-0.5 z-10 inline-flex items-center justify-center rounded-full border border-background bg-primary text-primary-foreground ring-2 ring-background shadow-sm select-none",
